...
exoncount = 0
first5 = seq_record.seq[3745:3750]
last3 = seq_record.seq[93344:93353]
codons = last3.translate()
...
print "2. The first 5 nucleotides are: ", first5
print "3. The number of exons contained is: ", exoncount
print "4. The last 3 codons of the protein are: ", last3
print "5. The codons code for: ", codons
